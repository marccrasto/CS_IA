...
<div id="bg"></div>
<p>&nbsp;</p>
<form name="loginform" action="login_exec2.php" method="post">
	 <?php
		...
		?>
  <label for=""></label>
  <input type="text" name="ID_Number" id="" placeholder="Enter ID" class="email">
    
  <label for=""></label>
  <input type="password" name="Password" id="" placeholder="Enter Password" class="pass">
