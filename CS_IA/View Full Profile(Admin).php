...
$run_update=mysqli_query($conn, $c_update);
    ...
    if($run_update){
       ...
       // echo"<script>alert('Your Account has been Updated successfully, Thanks')</script>";
			  ...
			  header('Location: View Full Profile(Admin).php?updated=Success&&uid='.$_POST['user_id']);
    }
...
<?php }?>
           ...
           <table width="375" height="277" border="1" align="center">
             <tbody>
               ...
               <tr>
                 <td><input type="file" name="userImage"><br><br>
           ...
           <table width="100%" border="1">
             <tbody>
               ...
               <tr>
                 <td>Mail_ID</td>
                 <td><input value="<?php echo $row['Mail_ID'];?>" name="txtmailid" type="text"  >
</td>
               </tr>
               <tr>
                 <td>Gender</td>
