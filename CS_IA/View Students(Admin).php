...
include 'conn.php';
    ...
    $user_id=$_GET['del_userid'];


 // sql to delete a record
  $sqlDelete = "DELETE FROM tbl_registration WHERE ID=".$user_id;
  $runDelete=mysqli_query($conn, $sqlDelete);

  $sqlDelete1 = "DELETE FROM tbl_take_attendance WHERE Student_ID=".$user_id;
  $runDelete1=mysqli_query($conn, $sqlDelete1);
    ...
    if($runDelete){
			  ...
			  header('Location: View Students(Admin)?updated=Success');
    } else {
...
<form action="View Students.php" method="post" enctype="multipart/form-data" id="myForm" >
	<div class="header">
...
<div class="alert alert-success" style="color: green;">
  <strong>Success!</strong> User Deleted from the Table!
</div>
<?php }?>
	<table>
                <tr>
    ...
    return $filter_Result;
		...
		?>
                ...
                <tr>
                    ...
                    <td><center>
                      <a href="View Full Profile(Admin).php?uid=<?php echo $row['ID'];?>"> 
                                     <i class="fa fa-pencil"></i>Edit Profile Info</a>
                                     <!--<a href="clientview.php?ID=<?php echo $row['ID'];?>"> 
                                     <button class="btn btn-danger btn-xs" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash-o "></i></button></a>-->
                    </center>
</td>
					<td><center>
                      <a href="View Students(Admin).php?del_userid=<?php echo $row['ID'];?>"> 
                                     <i class="fa fa-pencil"></i>Delete Record</a>
