...
include 'conn.php';
 ...
 // sql to delete a record
  $sqlDelete = "DELETE FROM tbl_staff WHERE ID=".$user_id;
...
$runDelete=mysqli_query($conn, $sqlDelete);
    ...
    if($runDelete){
			  ...
			  header('Location: View Teachers.php?updated=Success');
    } else {
...
<div class="alert alert-success" style="color: green;">
  <strong>Success!</strong> Staff Deleted from the Table!
</div>
<?php }?>
	<table>
                <tr>
    ...
    return $filter_Result;
		...
		?>
                ...
                <tr>
					...
					<td>
						<center>
						<a href="View_Profile_Teacher.php?uid=<?php echo $row['ID'];?>"> 
					...
					<td>
						<center>
						<a href="View Teachers.php?del_userid=<?php echo $row['ID'];?>"> 
