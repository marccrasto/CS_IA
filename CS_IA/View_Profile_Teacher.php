...
if($c_image_temp != "")
{
    ...
    $c_update="update tbl_staff set Name='$txtname', Email_ID='$txtmailid', Gender='$txtgender',  Mobile= '$txtmobile',  City= '$txtcity',  State= '$txtstate',  Country= '$txtcountry',  Department= '$txtdepartment', Image_Location='$uploadImageName' where ID='$user_id'";   
}else
{
    $c_update="update tbl_staff set Name='$txtname', Email_ID='$txtmailid', Gender='$txtgender',  Mobile= '$txtmobile',  City= '$txtcity',  State= '$txtstate',  Country= '$txtcountry',  Department= '$txtdepartment' where ID='$user_id'"; 
}
...
$run_update=mysqli_query($conn, $c_update);
    ...
    if($run_update){
       ...
       // echo"<script>alert('Your Account has been Updated successfully, Thanks')</script>";
			  ...
			  header('Location: View_Profile_Teacher.php?updated=Success&&uid='.$_POST['user_id']);
    }
...
<body>
	...
	$ret=mysqli_query($conn,"SELECT * FROM `tbl_staff` WHERE ID='".$_GET['uid']."'");
...
<?php }?>
           ...
           <table width="375" height="277" border="1" align="center">
             <tbody>
               ...
               <tr>
				 ...
				 <strong><img src="<?php echo $row['Image_Location']; ?>" width="374" height="262"></strong></td>
               </tr>
             </tbody>
           </table>
           ...
           <table width="100%" border="1">
             <tbody>
               ...
               <tr>
                 <td>Mail_ID</td>
                 <td><input value="<?php echo $row['Email_ID'];?>" name="txtmailid" type="text"  ></td>
               </tr>
               <tr>
                 <td>Gender</td>
